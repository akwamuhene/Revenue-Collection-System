...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Birim Central Municipal Assembly - Collectors</title>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="alert alert-info text-center">
                        <?php
                        $RTIs="select count(*)as count from users where `access`=2";
                        $result=$conn->query($RTIs);
                        $RTIs=mysqli_fetch_assoc($result)["count"];
                        ?>
                        <i class="fas fa-user-tag fa-3x"></i>&nbsp;<b><?php echo number_format($RTIs); ?></b> Registered Revenue Collectors
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo $row['dateregistered']; ?></td>
                                            <td>
                                                <a href="delete_user.php<?php echo '?id='.$uid; ?>">
                                                <button class="btn btn-danger"><i class="fas fa-times"></i> Remove </button></a>
                                                <?php if ($suspend==1) {
                                                 ?>
                                                 <a href="unsuspend_user.php<?php echo '?id='.$uid; ?>">
                                                <button class="btn btn-warning"><i class="fas fa-exclamation-triangle"></i> Suspended</button></a></td>
                                            <?php }elseif ($suspend==0)
                                               { ?>
                                                <a href="suspend_user.php<?php echo '?id='.$uid; ?>">
                                                <button class="btn btn-warning"><i class="fas fa-exclamation-triangle"></i> Suspend</button></a></td>
                                                <?php } ?>
                                        </tr>
                                        <?php
                                          }
