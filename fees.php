<div class="card-body" name="fees" id="fees" style="display:none;">
					  ...
					  <div class="row">
					    ...
					    <div class="col-lg-4 col-md-4 col-sm-4 mt-3">
						  ...
						  <select class="custom-select" name="tolltypeid">
						    <option disabled selected>fees type</option>
						    <?php 
            					$query = mysqli_query($conn,"select * from `tolltype` where subhead = 1");
